...
<div class="info-block-5 container-fluid info-block-5_detail info-block-5_detail-reverse">
    <div class="row">
        ...
        <a href="<?=$arResult['PROPERTIES']['IMAGE_PART_1']['VALUE']['SRC']?>" rel="gallery" class="col-8 col-md-6 col-xl-3 info-block-5__col-1 swipebox">
...
<div class="info-block-5 container-fluid info-block-5_detail">
    <div class="row">
        ...
        <a href="<?=$arResult['PROPERTIES']['IMAGE_PART_2']['VALUE']['SRC']?>" rel="gallery" class="col-8 col-md-6 col-xl-3 info-block-5__col-1 swipebox">
            <img class="info-block-5__img"
                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
